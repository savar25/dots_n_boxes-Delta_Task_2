    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        startg.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                {
                    String empty="";
                    if(row.getText().toString().isEmpty()){empty=empty.concat("Row ");}
                    if(col.getText().toString().isEmpty()){empty=empty.concat("Column ");}
                    if(p1Name.getText().toString().isEmpty()){empty=empty.concat("Player 1 ");}
                    if(p2Name.getText().toString().isEmpty()){empty=empty.concat("Player 2 ");}
                    Toast.makeText(MainActivity.this,empty+" values not mentioned",Toast.LENGTH_SHORT).show();
                }else if(Integer.parseInt(row.getText().toString())>11 || Integer.parseInt(col.getText().toString()) >11){
                    String val="";
                    if(Integer.parseInt(row.getText().toString())>11){val=val.concat("Row Value ");}
                    if(Integer.parseInt(col.getText().toString())>11){val=val.concat("Column Value ");}
                    Toast.makeText(MainActivity.this,val+"greater than 11",Toast.LENGTH_SHORT).show();
                }
                else {
